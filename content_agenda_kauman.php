<html>
<head>
<title>Agenda RS Mardiwaloeja Kauman-Malang</title>
...
<table width="100%" height="539" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    ...
    <td valign="top" bgcolor="#8f8f8f" class="background"><p><img src="images/agenda.png" width="450" height="50" ></p>
      <hr>
	  <div align="center" class="judulcontent">Agenda RS Mardiwaloeja Kauman-Malang
      </div>
	...
	$string="SELECT * FROM agenda where unit='RS Mardiwaluya Kauman'";
	...
	if($counter%2==0)$warna=$warna2; else $warna=$warna1;
		...
		echo"<td align='center'>".$row['id']."</td>
			 ...
			 <td align='center'>".$row['tempat']."</td>
 			 <td align='Left'>".substr($row['acara'],0,150)."....<a href='detail_content_agenda_kauman.php?id=".$row['id']."'>detail</a></td>
