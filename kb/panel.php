...
include('panel_funct1.php');
include('panel_funct2.php');
...
$task=$_GET['task'];
	...
	break;
	case 'menu_inpartunormal':
	pogi::menu_inpartunormal($option);
	break;
	case 'menu_inpartuoperasi':
	pogi::menu_inpartuoperasi($option);
	break;
	case 'menu_noninpartunormal':
	pogi::menu_noninpartunormal($option);
	break;
	case 'menu_noninpartuoperasi':
	pogi::menu_noninpartuoperasi($option);
	break;
	case 'menu_obat':
	pogi::menu_obat($option);
	break;
	case 'menu_pakaiobat':
	pogi::menu_pakaiobat($option);
	break;
