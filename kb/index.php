...
<title>&nbsp; Halaman Kamar Bersalin RS Mardi Waluyo Malang &nbsp;</title>
...
<embed src='../img/header.swf' width='1024' height='250'></embed>
</td>
</tr>
...
<br>
	...
	<IMG class=arrow alt=- src="anggota.png" width="15"><A href='index.php?task=index'>Home</a>
	</SPAN>

	   <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=gt_ac'>Account</a></SPAN>


	   <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href="index.php?task=menu_identpas">Identitas Pasien</a></SPAN>

	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href="index.php?task=menu_inpartunormal">Inpartu Normal</a></SPAN>


	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href="index.php?task=menu_inpartuoperasi">Inpartu Operasi</a></SPAN>


	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=shbi'>Kesehatan Bayi</a></SPAN>


	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href="index.php?task=menu_noninpartunormal">NonInpartu Normal</a></SPAN>


		<SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href="index.php?task=menu_noninpartuoperasi">NonInpartu Operasi</a></SPAN>


	 <SPAN  class=title>
	 <IMG class=arrow alt=- src="anggota.png" width="15"><a href="index.php?task=menu_obat">Obat/ Alkes</a></SPAN>


	 <SPAN  class=title>
	 <IMG class=arrow alt=- src="anggota.png" width="15"><a href="index.php?task=menu_pakaiobat">Pemakaian Obat/ Alkes</a></SPAN>


	 <SPAN  class=title>
	 <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=absensi'>Absensi Pasien</a></SPAN>

	 <SPAN  class=title>
	 <IMG class=arrow alt=- src="anggota.png" width="15"><a href='logout.php'>Logout</a></SPAN>
