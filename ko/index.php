...
<title>&nbsp; Halaman Kamar Obat RS Mardi Waluyo Malang &nbsp;</title>
...
<br>
	...
	<IMG class=arrow alt=- src="anggota.png" width="15"><A href='index.php?task=index'>Home</a>
	  ...
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=gt_ac'>Account</a></SPAN>
	   ...
	   <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_hargaobat'>Harga Obat</a></SPAN>


	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_dataobat'>Data Obat</a></SPAN>


	<SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_apotik'>Apotik</a></SPAN>
