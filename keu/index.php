...
<title>&nbsp; Bagian Keuangan RS Mardi Waluyo Malang &nbsp;</title>
...
<embed src='../header.swf' width='1024' height='250'></embed>
</td>
</tr>
...
<br>
	...
	<IMG class=arrow alt=- src="anggota.png" width="15"><A href='index.php?task=index'>Home</a>
	  ...
	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_dptklr'>Pendapatan & Pengeluaran</a></SPAN>


	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_kaber'>Kamar Bersalin</a></SPAN>



	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_ka'>Kamar Anak</a></SPAN>


	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_ko'>Kamar Obat</a></SPAN>


	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=pasienx'>Rincian Biaya Pasien</a></SPAN>
