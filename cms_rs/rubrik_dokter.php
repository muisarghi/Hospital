...
<html>
<head>
<title>Halaman Dokter Menjawab</title>
  ...
  <tr>
    ...
    <td align="center" valign="top" bgcolor="#8f8f8f"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <?php
	   ...
	   if($_GET['action']=="delete"){ mysql_query("delete from rubrik where id='".mysql_real_escape_string($_GET['id'])."'");}
	   
	   $sqlstr="Select * from rubrik";
	   $sqlquery=mysql_query($sqlstr);
	   
	   while($row=mysql_fetch_array($sqlquery)){	
	   
	   	echo "<table width='804' border='0' cellspacing='0' cellpadding='4'>
        <tr>
          <td width='525'>"; 
		...
		echo "</td>
          <td width='263'>
		  <a href='rubrik_dokter.php?id=".$row['id']."&action=delete'>Delete</a> | <a href='jawab_dokter.php?id=".$row['id']."'>Jawab</a>
