...
<html>
<head>
<title>Edit Profile Administrator</title>
...
<table width="100%" height="539" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    ...
    <hr>
    <p class="judulcontent">Edit Daftar Profile </p>
<?php
include 'con_rs.php';
$sqlstr= "SELECT * FROM profile WHERE idprof='".mysql_real_escape_string($_GET['id'])."'";   
$result=mysql_query($sqlstr) or die ("Tidak bisa menemukan tabel");
$row=mysql_fetch_array($result);
?>
	<form action="simpan_edit_profile_adm.php" name="formeditprofile" method="post" enctype="multipart/form-data">
    <table width="728" border="1" cellpadding="5" cellspacing="0" class="marque">
     <tr>
        <td width="96" align="right">Judul</td>
		<input type="hidden" name="id" value="<? echo $row['idprof']?>" >
      ...
      <tr>
        ...
        <td valign="top"><img src='../<? echo $row['foto'] ?>' width="100" ><br>
          <input type="file" name="foto" value=""></td>
      </tr>
      <tr>
