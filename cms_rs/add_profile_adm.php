...
<table width="100%" height="539" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    ...
    <hr>
    <p class="judulcontent">Tambah Daftar Profile </p>
	<form action="simpan_add_profile_adm.php" name="formsimpanprofile" method="post" enctype="multipart/form-data">
    <table width="728" border="1" cellpadding="5" cellspacing="0" class="marque">
     <tr>
        <td width="96" align="right">Judul</td>
        <td width="626"><input type="text" name="judul" id="idjudul" size="30">        </td>
      </tr>
      <tr>
        <td align="right">Isi Profile </td>
        <td><textarea name="isi" cols="80" rows="40" style="background-color:#FBEAD2"></textarea></td>
      </tr>
      <tr>
        <td align="right">Foto Profile </td>
      ...
      <tr>
        <td align="right">&nbsp;</td>
        <td><a href="profile_adm.php"><input type="submit" name="submit" value="Simpan"> | <input type="reset" name="reset" value="Batal"></a></td>
      </tr>
    </table>	
	</form>
    <p>&nbsp;</p></td>
