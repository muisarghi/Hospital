...
<title>&nbsp; Halaman Kamar Bayi RS Mardi Waluyo Malang &nbsp;</title>
...
<br>
	...
	<IMG class=arrow alt=- src="anggota.png" width="15">Home
	  ...
	  <a href='index.php?task=gt_ac'>-> Ganti Account</a>
	   ...
	   <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15">Daftar Bayi</SPAN>

	  <DIV class=submenu>
	  <a href='index.php?task=dafby&status=Bayi'>--> Daftar Bayi</b></a>
	 <?php/* <a href='index.php?task=in_sebabmati&status=Bayi'>--> Sebab Kematian</a>*/?>

      </DIV>


	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15">Kamar Anak</SPAN>

      <DIV class=submenu>

	  <a href='index.php?task=inots&status=Bayi'>-><b> Observasi Tensi Suhu</b></a>
	  <a href='index.php?task=inidlp&status=Bayi'>-> <b>Instruksi Dokter & Laporan</b></a>
	  <a href='index.php?task=inrsm&status=Bayi'>-> <b>Resume Medik</b></a>
	  <a href='index.php?task=ppp&status=Bayi'>-> <b>Pernyataan Pulang Paksa</b></a>
	  <a href='index.php?task=ttm&status=Bayi'>-> <b>Penolakan Tindakan Medik</b></a>
	  <a href='index.php?task=srtmt&status=Bayi'>-> <b>Surat Kematian</b></a>
	  <a href='index.php?task=rjk&status=Bayi'>-> <b>Rujukan Penderita</b></a>
	  <a href='index.php?task=bp&status=Bayi'>-> <b>Biaya Perawatan</b></a>
	  <a href='index.php?task=byalkes&status=Bayi'>-> <b>Pemakaian Obat & Susu</b></a>
	  <a href='index.php?task=blsusu&status=Bayi'>-> <b>Pembelian Susu</b></a>
	...
	<SPAN  class=title>
	 ...
	 <DIV class=submenu>
	 <a href='index.php?task=mutasi'>Mutasi Obat</a>
	 </DIV>
