...
<title>&nbsp; Halaman Receptionist RS Mardi Waluyo Malang &nbsp;</title>
...
<br>
	...
	<IMG class=arrow alt=- src="anggota.png" width="15"><A href='index.php?task=index'>Home</a>
	  ...
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=gt_ac'>Account</a></SPAN>
		...
		<SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_pasbar'>Pasien Baru</a></SPAN>


	<SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_infopas'>Informasi Pasien</a></SPAN>

	<SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_infokmr'>Informasi Kamar/Kelas</a></SPAN>
