...
<title>&nbsp; Halaman Kamar Anak RS Mardi Waluyo Malang &nbsp;</title>
...
<br>
	...
	<IMG class=arrow alt=- src="anggota.png" width="15"><b><A href='index.php?task=index'>HOME</a></b>
	</SPAN>
	  ...
	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_kamaranak'>Kamar Anak</a></SPAN>

	  <SPAN  class=title>
	 <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=mutasi'>Mutasi Obat</a></SPAN>
	...
	<DIV class=sdmenu>
	<SPAN class=title id=top>
	<IMG class=arrow alt=- src="anggota.png" width="15"><b>KAMAR BAYI</b>
	</SPAN>


	   <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=dafby&status=Bayi'>Daftar Bayi</a></SPAN>


	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_kamarbayi'>Kamar Bayi</a></SPAN>




	<SPAN  class=title>
	 <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=absensib'>Absensi Pasien</a></SPAN>
