...
<title>&nbsp; Halaman Poli (Dokter) RS Mardi Waluyo Malang &nbsp;</title>
...
<br>
	...
	<IMG class=arrow alt=- src="anggota.png" width="15"><A href='index.php?task=index'>Home</a>
	   ...
	   <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_account'>Account</a></SPAN>


	<!--PERAWAT -->
	  <DIV class=sdmenu>
	<SPAN class=title id=top>
	<IMG class=arrow alt=- src="anggota.png" width="15"><b>RECEPTIONIST</b>
	</SPAN>

	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=menu_pasien'>Data Pasien</a></SPAN>


<!--- DOKTER-->
<SPAN class=title id=top>
	<IMG class=arrow alt=- src="anggota.png" width="15"><b>DOKTER</b>
	</SPAN>
 <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=dafantrian&status=poli'>Pemeriksaan Pasien</a></SPAN>


<!--OBAT -->
	  <DIV class=sdmenu>
	<SPAN class=title id=top>
	<IMG class=arrow alt=- src="anggota.png" width="15"><b>Pelayanan Obat</b>
	</SPAN>
	 <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='index.php?task=resep&status=poli'>Obat Pasien</a></SPAN>
