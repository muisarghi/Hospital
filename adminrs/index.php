...
<title>&nbsp; Halaman Administrator RSIA Mardi Waloeja&nbsp;</title>
...
<center><b>MENU</b></center>
	...
	<DIV class=sdmenu><SPAN class=title id=top><IMG class=arrow alt=-
      src="anggota.png" width="15"><a href='index.php?task=index'>Home</a></SPAN>
	  ...
	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15">KeAnggotaan/Dokter</SPAN>

      <DIV class=submenu>
	  <a href='index.php?task=dft_an'>-> Daftar Anggota</a>
	  <a href='index.php?task=tmb_an'>-> Tambah Anggota</a>
	  <a href='index.php?task=dok'>-> Dokter</a>
      </DIV>

	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15">Konfigurasi Kelas</SPAN>

      <DIV class=submenu>
	  <a href='index.php?task=konf_rg'>-> Ruangan Pasien</a>
	  <a href='index.php?task=konf_rgby'>-> Ruangan Anak/ Bayi</a>

      </DIV>

	  <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15">Konfigurasi Asuransi</SPAN>

      <DIV class=submenu>
	  <a href='index.php?task=konf_by'>-> Konfigurasi Asuransi</a>

      </DIV>

	   <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15">Konfigurasi Biaya Poli</SPAN>

      <DIV class=submenu>
	  <a href='index.php?task=tiket'>-> Biaya Tiket</a>
	  <a href='index.php?task=dokter'>-> Biaya Dokter</a>
	 ...
	 <SPAN  class=title>
	  <IMG class=arrow alt=- src="anggota.png" width="15"><a href='logout.php'>LOG out</a></SPAN>
