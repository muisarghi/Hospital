...
<table width="100%" height="539" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    ...
    <td valign="top" bgcolor="#8f8f8f"><p><img src="images/agenda.png" width="450" height="50"></p>
      <hr>
	  <?php
	include"con_rs.php";
	...
	?>
      ...
      <table width="681" border="0" align="center" cellpadding="3" cellspacing="0" class="konten2" >
        <tr>
